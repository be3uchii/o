...
Frame.Size = UDim2.new(0, 252, 0, 330)
Frame.Position = UDim2.new(0.5, -126, 0.5, -165)
...
LogoDot.Position = UDim2.new(0, 16, 0.5, -3)
...
local function CreatePage()
	...
	page.Position = UDim2.new(0, 10, 0, 84)
...
local function CreateToggle(parent, text, info, callback)
	...
	local function render()
		if state then
			...
			tw(knob, 0.18, {Position = UDim2.new(1, -17, 0.5, -7)}):Play()
		else
			tw(track, 0.18, {BackgroundColor3 = TOGGLE_OFF}):Play()
			tw(knob, 0.18, {Position = UDim2.new(0, 3, 0.5, -7)}):Play()
		end
	end
...
local function CreateStepper(parent, text, values, labels, callback)
	...
	local controlH = 24
	local controlX = 1
	local controlOX = -(controlW + 8)
	local controlOY = controlH / 2

	local controlFrame = Instance.new("Frame", card)
	controlFrame.Size = UDim2.new(0, controlW, 0, controlH)
	controlFrame.Position = UDim2.new(controlX, controlOX, 0.5, -controlOY)
...
PlayerListPanel.Size = UDim2.new(0, 220, 0, 250)
PlayerListPanel.Position = UDim2.new(1, 10, 0, 0)
...
plTitle.Size = UDim2.new(1, -46, 0, 38)
...
plClose.Position = UDim2.new(1, -34, 0, 7)
...
plScroll.Size = UDim2.new(1, -12, 1, -44)
plScroll.Position = UDim2.new(0, 6, 0, 40)
...
local function MakePlayerRow(player)
	...
	av.Position = UDim2.new(0, 7, 0.5, -14)
