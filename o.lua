...
local ACCENT_ON   = Color3.fromRGB(96, 165, 255)
local ACCENT_2    = Color3.fromRGB(168, 130, 255)
local ACCENT_GLOW = Color3.fromRGB(140, 195, 255)
local BG_MAIN     = Color3.fromRGB(15, 16, 21)
local BG_PANEL    = Color3.fromRGB(24, 25, 32)
local BG_CARD     = Color3.fromRGB(30, 32, 41)
local BG_CARD_HOV = Color3.fromRGB(39, 42, 54)
local TXT_PRIMARY = Color3.fromRGB(240, 242, 248)
local TXT_DIM     = Color3.fromRGB(128, 132, 146)
local STROKE_SOFT = Color3.fromRGB(46, 49, 62)
local TOGGLE_OFF  = Color3.fromRGB(54, 57, 70)
