...
ToggleUIBtn.Position = UDim2.new(0, 8, 0.5, -13)
...
LogoDot.Position = UDim2.new(0, 9, 0.5, -2)
...
CloseBtn.Position = UDim2.new(1, -23, 0.5, -9)
...
TabBar.Position = UDim2.new(0, 8, 0, 31)
...
local function CreatePage()
	...
	page.Position = UDim2.new(0, 6, 0, 60)
...
local function CreateToggle(parent, text, info, callback)
	...
	sub.Size = UDim2.new(1, -52, 0, 11)
	sub.Position = UDim2.new(0, 8, 0, 20)
	sub.Text = info
	...
	track_frame.Size = UDim2.new(0, 28, 0, 15)
	track_frame.Position = UDim2.new(1, -36, 0.5, -7)
	...
	if PlayerListPanel then
		...
		if v then
			task.defer(function()
				...
				PlayerListPanel.Position = UDim2.new(0, fx + 228, 0, fy)
			end)
			RefreshPlayerList()
		end
	end
...
plClose.Size = UDim2.new(0, 18, 0, 18)
plClose.Position = UDim2.new(1, -24, 0, 5)
