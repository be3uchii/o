...
local function StartFly()
	...
	flyConnection = RunService.RenderStepped:Connect(function()
		...
		if rawDir.Magnitude > 0 then
			...
			moveDir = moveDir + camFlat * (-rawDir.Z) + camRight * rawDir.X
		end

		local isJumpPressed = UserInputService:IsKeyDown(Enum.KeyCode.Space)
			or UserInputService:IsKeyDown(Enum.KeyCode.ButtonA)
		local isDownPressed = UserInputService:IsKeyDown(Enum.KeyCode.LeftControl)
			or UserInputService:IsKeyDown(Enum.KeyCode.ButtonB)
