...
local TXT_FAINT   = Color3.fromRGB(95, 95, 106)
...
local function CreatePage(headerText)
...
local function CreateTab(name, headerText)
	...
	lbl.TextSize = 10
	lbl.ZIndex = 8
	local page = CreatePage(headerText)
	pages[name] = page
...
local EspPage    = CreateTab("ESP", "V I S U A L S")
local CombatPage = CreateTab("Combat", "C O M B A T")
local MiscPage   = CreateTab("Misc", "U T I L I T I E S")
