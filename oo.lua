...
local function isValidFuel(obj)
    if not obj then return false end
    local objType = obj:IsA("BasePart") or obj:IsA("Model") or obj:IsA("Tool")
    if not objType then return false end
    
    local name = obj.Name:lower()
    if name:find("fuelzone") or name:find("zone") then return false end
    if name == "fuel" or name:find("^fuel$") then return true end
